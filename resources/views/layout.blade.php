...
{{--       Instead of using images/logo.png, we can use the asset() function to fetch the image from the public directory.--}}
    ><img class="w-40 mx-10" src="{{asset('images/logo.png')}}" alt="" class="logo"
        /></a>
    <ul class="flex flex-col mx-10 text-lg">
        <li class="my-1.5">
            <a href="register.html" class="text-white"
            ><i class="mx-1.5 fa-solid fa-user text-white"></i> Register</a
            >
        </li>
        <li class="my-1.5">
            <a href="login.html" class="text-white"
            ><i class="mx-1.5 fa-solid fa-arrow-right-to-bracket text-white"></i>
                Login</a
            >
        </li>
    </ul>
...
>
    ...
    <a
        href="create.html"
        class="absolute top-1/3 right-10 bg-customPurple text-white py-2 px-5 hover:bg-customDarkPink hover:text-white rounded-xl"
    >Post Anime</a
    >
</footer>
</body>
